...
<head>
	...
	<meta name="description" content="Blue Box Management System">
                    ...
                    <div class="col-lg-4 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-12 col-xs-12 no-padding fitxt-center">
                        ...
                        <div class="content">
                            <div class="image-hader">
                                <h2><?php echo translate('Welcome, shall we?');?></h2>
                            </div>
                            <div class="center img-hol-p">
                                <img src="<?php echo base_url('uploads/app_image/_CompanyLogo.png');?>" height="60" alt="BlueBox BJS">
                            </div>
                            <div class="address">
                    ...
                    <div class="col-lg-6 col-lg-offset-right-1 col-md-6 col-md-offset-right-1 col-sm-12 col-xs-12 no-padding">
                        <div class="sign-area">
                            <div class="sign-hader">
                                <img src="<?php echo base_url('uploads/app_image/_CompanyLogo.png');?>" height="54" alt="Benoni JS">
                            ...
                            <?php echo form_open($this->uri->uri_string()); ?>
                                ...
                                <div class="forgot-text">
                                    ...
                                    <div class="">
                                        <a href="<?php echo base_url('authentication/forgot');?>"><?php echo translate('lost_your_password');?></a>
                                    </div>
                                </div>
